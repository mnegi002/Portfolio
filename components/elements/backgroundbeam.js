    ...
    <div className="h-screen w-full  rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        ...
        <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center relative z-10 mt-4">
          I have delivered more than 20 projects using a variety of technologies including HTML, CSS, Bootstrap, TailWind, React.js, Node.js, JavaScript, MongoDB, Next.js, Express.js, and WebSocket.io.
        </p>
